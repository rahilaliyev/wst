   <?php 
    ...
    $tutor_intor_video_image = get_theme_mod( 'tutor_intor_video_image', $defaults['tutor_intor_video_image']);
    $tutor_custom_placeholder_image = get_theme_mod( 'tutor_custom_placeholder_image', $defaults['tutor_custom_placeholder_image']);
